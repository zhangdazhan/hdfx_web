(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app"], {
    ...
    "0bb4": function (t, a, e) {
        ...
        function n(t) {
            return Promise.resolve({ data: [{ id: 1, text: "软件数据仅供参考", state: "open" }] });
        }
        function o(t) {
            ...
            , A = {
                login: function (t, a) {
                    ...
                    return new Promise((function (t, a) {
                        var _account = c.trim();
                        var _password = i;
                        if (!window.__hdfx_mqtt || !window.__hdfx_mqtt.login) {
                            return a("MQTT 模块未加载");
                        }
                        window.__hdfx_mqtt.login(_account, _password).then((function (result) {
                            e("SET_TOKEN", result.token || _account),
                                e("SET_ROLE", result.role || "user"),
                                e("SET_VIPTIME", result.viptime || ""),
                                Object(y["c"])(result.token || _account);
                            t()
                        })).catch((function (err) {
                            a(err.reason || err.message || "登录失败")
                        }))
                    }))
                },
                getInfo: function (t) {
                ...
                logout: function (t) {
                    ...
                    return new Promise((function (t) {
                        // 断开 MQTT
                        if (window.__hdfx_mqtt && window.__hdfx_mqtt.disconnect) {
                            window.__hdfx_mqtt.disconnect();
                        }
                        // 清除 token 和状态
                        Object(y["b"])(),
                            Object(j["b"])(),
        ...
        var c = e("2b0e")
            ...
            , h = (window.innerWidth,
            {
                ...
                mounted: function () {
                    ...
                    function a() {
                        var t = window.innerWidth / 1920;
                        try { console.log(self.$route && self.$route.path); } catch (err) {}
                        $("html").css("zoom", t)
                    }
                    function e() {
    ...
    "60a8": function (t, a, e) {
        ...
        var c = e("b775")
            , i = {
                getOddsHistory: "https://webapi.sporttery.cn/gateway/uniform/football/getOddsHistoryV1.qry",
    ...
    "9d9f": function (t, a, e) {
        ...
        function n(t) {
            return window.__hdfx_mqtt.planRequest("plan_list", t)
        }
        function o(t) {
            var action = t.uuid ? "plan_update" : "plan_create";
            return window.__hdfx_mqtt.planRequest(action, t);
        }
        function l(t) {
            return window.__hdfx_mqtt.planRequest("plan_delete", t)
        }
    },
    "9eaf": function (t, a, e) {
    ...
    a18c: function (t, a, e) {
        ...
        var c, i, n = e("2b0e"), o = e("8c4f"), l = function () {
            ...
            return c("div", {
                ...
                on: {
                    click: function (a) {
                        t.seltgame = t.cccaluteData.planId,
                            t.jietuVisible = !0,
                            t.sportteryUrl = "lqdg" == t.gametype ? "/sporttery/lqhhgg.html" : "/sporttery"
                    }
                }
            }, [t._v(" 截图 ")])], 1), c("td", {
                staticStyle: {
            ...
            }, [t._v(" " + t._s((t.cccaluteData.HgProfit1 || t.cccaluteData.JcProfit) && parseFloat(t.cccaluteData.HgProfit1 || t.cccaluteData.JcProfit).toFixed(0)) + " "), c("span", {
                class: {
            ...
            }, [t._v(" " + t._s((t.cccaluteData.HgProfit2 || t.cccaluteData.JcProfit) && parseFloat(t.cccaluteData.HgProfit2 || t.cccaluteData.JcProfit).toFixed(0)) + " "), c("span", {
                class: {
                ...
                on: {
                    change: function (a) {
                        if (t.qbcaluteData.JCgoalLine1_1 === t.qbcaluteData.JCgoalLine2_1 && t.qbcaluteData.JCTouz1_1 === t.qbcaluteData.JCTouz2_1) t.$set(t.qbcaluteData, "JCTzOdd2_1", a);
                        return t.qbcomputeData()
                    }
                },
                model: {
                ...
                on: {
                    change: function (a) {
                        if (t.qbcaluteData.JCgoalLine1_2 === t.qbcaluteData.JCgoalLine2_2 && t.qbcaluteData.JCTouz1_2 === t.qbcaluteData.JCTouz2_2) t.$set(t.qbcaluteData, "JCTzOdd2_2", a);
                        return t.qbcomputeData()
                    }
                },
                model: {
                ...
                on: {
                    change: function (a) {
                        if (t.qbcaluteData.JCgoalLine1_1 === t.qbcaluteData.JCgoalLine2_1 && t.qbcaluteData.JCTouz1_1 === t.qbcaluteData.JCTouz2_1) t.$set(t.qbcaluteData, "JCTzOdd1_1", a);
                        return t.qbcomputeData()
                    }
                },
                model: {
                ...
                on: {
                    change: function (a) {
                        if (t.qbcaluteData.JCgoalLine1_2 === t.qbcaluteData.JCgoalLine2_2 && t.qbcaluteData.JCTouz1_2 === t.qbcaluteData.JCTouz2_2) t.$set(t.qbcaluteData, "JCTzOdd1_2", a);
                        return t.qbcomputeData()
                    }
                },
                model: {
        ...
        function Jt(t) {
            return window.__hdfx_mqtt.calcRequest("calc_sin", t);
        }
        function xt(t) {
            return window.__hdfx_mqtt.calcRequest("calc_qb", t);
        }
        function At(t) {
            return window.__hdfx_mqtt.calcRequest("calc_chuan", t);
        }
        function wt(t) {
            return window.__hdfx_mqtt.calcRequest("calc_totalgoal", t);
        }
        function Bt(t) {
            return window.__hdfx_mqtt.calcRequest("calc_bqc", t);
        }
        var kt = e("9d9f");
        var Ft = {
        ...
        function Ht(t) {
            // 配置已通过 MQTT auth 推送，这里返回缓存
            var cache = window.__hdfx_mqtt && window.__hdfx_mqtt.getCache && window.__hdfx_mqtt.getCache();
            if (cache && cache.config) return Promise.resolve({ data: cache.config });
            return Promise.resolve({ data: null });
        }
        function Gt(t) {
            if (window.__hdfx_mqtt) {
                window.__hdfx_mqtt.publishConfig(t);
            }
            return Promise.resolve({ success: true });
        }
        var qt = e("5c96")
        ...
        var Rt = {
            ...
            watch: {
                ...
                cccalshow: function (t) {
                    ...
                    this.cccaluteData.HGPoint = "") : (this.cccaluteData.JCPoint = this.configData.JCPointChuan || "",
                    this.cccaluteData.HGPoint = this.configData.HGPoint || "")
                },
                $route: "routerChange"
            },
            mounted: function () {
            ...
            methods: {
                                ...
                                switch (a.prev = a.next) {
                                    case 0:
                                        return e = 1,
                                            ...
                                            t.cccaluteData.jcMatch1 = t.currJcMatch1,
                                            t.cccaluteData.jcMatch2 = t.currJcMatch2,
                                            t.cccaluteData.matchNumStr1 = t.currJcMatch1 && t.currJcMatch1.matchNumStr || t.cccaluteData.matchNumStr1 || "",
                                            t.cccaluteData.matchNumStr2 = t.currJcMatch2 && t.currJcMatch2.matchNumStr || t.cccaluteData.matchNumStr2 || "",
                                            a.next = 12,
                                            t.computeDatacc();
                                    case 12:
                ...
                jietu: function (t, a) {
                    var e = ""
                        , c = "";
                    if ("lqdg" == a) {
                        if (this.sportteryUrl = "/sporttery/lqhhgg.html",
                        ...
                        switch (this.sportteryUrl = "/sporttery/",
                ...
                dealShowData: function (t, a, e) {
                    ...
                    "-" === i ? this.twoDatas[t - 1].jcodds = [{
                        ...
                        goalLine: "-"
                    }] : this.twoDatas[t - 1].jcodds = (function(a,c,i){
                        if (i === a.hilo_goalLine) return [{type:"大小> "+a.hilo_goalLine,a:a.hilo_a,h:a.hilo_h,goalLine:a.hilo_goalLine}];
                        if ("lq"===c) for(var _k=1;_k<6;_k++) if(a["hilo_goalLine"+_k]===i) return [{type:"大小> "+i,a:a["hilo_a"+_k],h:a["hilo_h"+_k],goalLine:i}];
                        return [{
                ...
                ccCalcute: function (t) {
                    ...
                    this.clearCcData(i),
                        ...
                        this.cccaluteData.JCPoint = this.configData.JCPointChuan || "",
                        this.cccaluteData.HGPoint = this.configData.HGPoint || "",
                ...
                flashccOdds: function () {
                    var t = this;
                    t.currJcMatch1 && t.dealShowData(1, t.currJcMatch1, t.cccaluteData.hgMatch1),
                    t.currJcMatch2 && t.dealShowData(2, t.currJcMatch2, t.cccaluteData.hgMatch2),
                        ...
                        return Object(r["a"])().wrap((function (e) {
                            while (1)
                                switch (e.prev = e.next) {
                                    case 0:
                                        console.log("[方案] selectccGames 打开方案:", {planId: (t.ccDatas||t).planId, matchId1: (t.ccDatas||t).matchId1, matchId2: (t.ccDatas||t).matchId2, has_jcMatch1: !!(t.jcMatch1), has_cccJcMatch1: !!((t.ccDatas||t).jcMatch1), has_jc1: !!((t.ccDatas||t).jc1), matchNumStr1: (t.ccDatas||t).matchNumStr1, matchNumStr2: (t.ccDatas||t).matchNumStr2, HGgoalLine1_1: (t.ccDatas||t).HGgoalLine1_1, hgMatch1: (t.ccDatas||t).hgMatch1}),
                                        a.gametype = t.gametype,
                                            a.cccaluteData = t.ccDatas || t,
                                            a.cccaluteData.JCPoint = a.configData.JCPointChuan || "",
                                            a.cccaluteData.HGPoint = a.configData.HGPoint || "",
                                            c = t.jcMatch1 || a.cccaluteData.jcMatch1 || a.JCInfos && a.JCInfos[a.cccaluteData.matchId1] || a.cccaluteData.jc1 || (a.cccaluteData.matchNumStr1 ? {matchNumStr: a.cccaluteData.matchNumStr1, matchId: a.cccaluteData.matchId1} : null),
                                            i = t.jcMatch2 || a.cccaluteData.jcMatch2 || a.JCInfos && a.JCInfos[a.cccaluteData.matchId2] || a.cccaluteData.jc2 || (a.cccaluteData.matchNumStr2 ? {matchNumStr: a.cccaluteData.matchNumStr2, matchId: a.cccaluteData.matchId2} : null),
                                            n = t.hgMatch1 || a.cccaluteData.hgMatch1 || a.HGInfos && a.HGInfos[a.cccaluteData.matchId1] || a.cccaluteData.hg1,
                                            o = t.hgMatch2 || a.cccaluteData.hgMatch2 || a.HGInfos && a.HGInfos[a.cccaluteData.matchId2] || a.cccaluteData.hg2,
                                            c && c.matchNumStr && "3" === c.matchNumStr.slice(2, 3) ? a.gametype = "lqdg" : a.gametype = "",
                                            a.currJcMatch1 = c,
                                            a.currJcMatch2 = i,
                                            a.cccaluteData.hgMatch1 = n || a.cccaluteData.hgMatch1,
                                            a.cccaluteData.hgMatch2 = o || a.cccaluteData.hgMatch2,
                                            c && n && a.dealShowData(1, c, n),
                                            i && o && a.dealShowData(2, i, o),
                                            c && (a.cccaluteData.planName1 = a.dealPlanName(c.matchNumStr, a.cccaluteData.JCTouz1, a.cccaluteData.JCgoalLine1, a.cccaluteData.JCTzOdd1, a.gametype)),
                                            i && (a.cccaluteData.planName2 = a.dealPlanName(i.matchNumStr, a.cccaluteData.JCTouz2, a.cccaluteData.JCgoalLine2, a.cccaluteData.JCTzOdd2, a.gametype)),
                                            ...
                                            a.yields = a.comAccDiv(a.cccaluteData.HgProfit1 || a.cccaluteData.JcProfit, a.cccaluteData.JCTzAmt),
                                ...
                                switch (a.prev = a.next) {
                                    case 0:
                                        return e = {},
                                            ...
                                            e.JCTzOdd1_1 = t.qbcaluteData.JCTzOdd1_1,
                                            e.JCTzOdd1_2 = t.qbcaluteData.JCTzOdd1_2,
                                            e.JCTzOdd2_1 = t.qbcaluteData.JCTzOdd2_1,
                                            e.JCTzOdd2_2 = t.qbcaluteData.JCTzOdd2_2,
                                            e.JCgoalLine1_1 = t.qbcaluteData.JCgoalLine1_1,
                                            e.JCgoalLine1_2 = t.qbcaluteData.JCgoalLine1_2,
                                            e.JCgoalLine2_1 = t.qbcaluteData.JCgoalLine2_1,
                                            e.JCgoalLine2_2 = t.qbcaluteData.JCgoalLine2_2,
                                            e.JCTouz1_1 = t.qbcaluteData.JCTouz1_1,
                                            e.JCTouz1_2 = t.qbcaluteData.JCTouz1_2,
                                            e.JCTouz2_1 = t.qbcaluteData.JCTouz2_1,
                                            e.JCTouz2_2 = t.qbcaluteData.JCTouz2_2,
                                            e.hgOdds1 = t.qbcaluteData.HGTzOdd1_1,
                                            e.hgOdds2 = t.qbcaluteData.HGTzOdd1_2,
                                            e.HGTzOdd1_1 = t.qbcaluteData.HGTzOdd1_1,
                                            e.HGTzOdd1_2 = t.qbcaluteData.HGTzOdd1_2,
                                            e.HGTzOdd2_1 = t.qbcaluteData.HGTzOdd2_1,
                                            e.HGTzOdd2_2 = t.qbcaluteData.HGTzOdd2_2,
                                            e.HGgoalLine1_1 = t.qbcaluteData.HGgoalLine1_1,
                                            e.HGgoalLine1_2 = t.qbcaluteData.HGgoalLine1_2,
                                            e.HGgoalLine2_1 = t.qbcaluteData.HGgoalLine2_1,
                                            e.HGgoalLine2_2 = t.qbcaluteData.HGgoalLine2_2,
                                            e.HGTouz1_1 = t.qbcaluteData.HGTouz1_1,
                                            e.HGTouz1_2 = t.qbcaluteData.HGTouz1_2,
                                            e.HGTouz2_1 = t.qbcaluteData.HGTouz2_1,
                                            e.HGTouz2_2 = t.qbcaluteData.HGTouz2_2,
                                            ...
                                            e.uuid = t.qbcaluteData.uuid,
                                            e.matchId1 = t.qbcaluteData.matchId1,
                                            e.matchId2 = t.qbcaluteData.matchId2,
                                            e.bunchType = t.qbcaluteData.bunchType,
                                            a.next = 16,
                                            xt(e);
                                    case 16:
                                        c = a.sent,
                            ...
                            while (1)
                                switch (a.prev = a.next) {
                                    case 0:
                                        ...
                                        return a.abrupt("return");
                                    case 2:
                                        t.ifAverg ? t.cccaluteData.yield = "Sin" : t.cccaluteData.yield = t.yields,
                                            t.cccaluteData.ifAverg = t.ifAverg;
                                        var _ho1 = [parseFloat(t.cccaluteData.HGTzOdd1_1)||0, parseFloat(t.cccaluteData.HGTzOdd1_2)||0].filter(function(v){return v>0});
                                        var _ho2 = [parseFloat(t.cccaluteData.HGTzOdd2_1)||0, parseFloat(t.cccaluteData.HGTzOdd2_2)||0].filter(function(v){return v>0});
                                        var _cr = null;
                                        if (window.ChuanCalc && window.ChuanCalc.compute) {
                                            _cr = window.ChuanCalc.compute({
                                                method1: t.cccaluteData.method1 || 'WL',
                                                method2: t.cccaluteData.method2 || 'WL',
                                                jcRebate: parseFloat(t.cccaluteData.JCPoint) || 0.07,
                                                hgRebate: parseFloat(t.cccaluteData.HGPoint) || 0.026,
                                                jcInput: parseFloat(t.cccaluteData.JCTzAmt) || 5000,
                                                jcOdds1: parseFloat(t.cccaluteData.JCTzOdd1) || 0,
                                                jcOdds2: parseFloat(t.cccaluteData.JCTzOdd2) || 0,
                                                hgOdds1: _ho1.length ? _ho1 : [1],
                                                hgOdds2: _ho2.length ? _ho2 : [1],
                                                yield: t.cccaluteData.yield,
                                                ifAverg: t.cccaluteData.ifAverg !== false
                                            });
                                        }
                                        var _p;
                                        if (_cr && _cr.success) {
                                            _cr.JCPoint = t.cccaluteData.JCPoint;
                                            _cr.HGPoint = t.cccaluteData.HGPoint;
                                            _cr.JCTzAmt = t.cccaluteData.JCTzAmt;
                                            _cr.yield = t.cccaluteData.yield || 'Sin';
                                            _cr.planId = t.cccaluteData.planId || '';
                                            _cr.ifAverg = t.cccaluteData.ifAverg !== false;
                                            _p = Promise.resolve({data: _cr});
                                        } else {
                                            _p = At(t.cccaluteData);
                                        }
                                        return a.next = 5, _p;
                                    case 5:
                                        e = a.sent,
                                            c = e && e.data,
                                            c && c.JcProfit !== undefined && (t.cccaluteData.JCAmount = c.JCAmount,
                                            ...
                                            t.ifAverg && (t.yields = t.comAccDiv(t.cccaluteData.HgProfit1 || t.cccaluteData.JcProfit, t.cccaluteData.JCTzAmt))),
                                            t.$forceUpdate();
                                    case 22:
                                    case "end":
                                        return a.stop()
                ...
                calculate: function (t) {
                    this.gametype = t.gametype,
                        this.caluteData = Object.assign({
                            uuid: t.matchInfo.uuid,
            ...
            , $t = Rt
            , Nt = (e("e8ca"),
                Object(v["a"])($t, l, s, !1, null, "19403240", null))
            , Vt = Nt.exports;
        n["default"].use(o["a"]);
        var Et = [{
            path: "/login",
            ...
            path: "/angentUser",
            component: function () {
                return e.e("chunk-426c668e").then(e.bind(null, "2bd1"))
            },
            hidden: !0
        }, {
            path: "/404",
            ...
            children: [{
                ...
                name: "平台适配器",
                component: function () {
                    return e.e("chunk-ddda2320").then(e.bind(null, "cc37"))
                },
                meta: {
                    title: "平台适配器",
                    icon: "dashboard"
            ...
            children: [{
                ...
                name: "地址管理",
                component: function () {
                    return e.e("chunk-1d365b2e").then(e.bind(null, "d0cc"))
                },
                meta: {
                    title: "地址管理",
                    icon: "dashboard"
                ...
                name: "公告管理",
                component: function () {
                    return e.e("chunk-779dc214").then(e.bind(null, "fbae"))
                },
                meta: {
                    title: "公告管理",
                    icon: "dashboard"
    ...
    b775: function (t, a, e) {
        ...
        var r = function (t) {
            if (t.response) {
                ...
                403 === t.response.status || 405 === t.response.status || t.response.status,
                    n["Message"].error(a.error)
            }
    ...
    c24f: function (t, a, e) {
        ...
        function o(t) {
            // 用户信息通过 MQTT 鉴权获取，不走 HTTP
            var mqtt = window.__hdfx_mqtt;
            if (mqtt && mqtt.getUserInfo) {
                var info = mqtt.getUserInfo();
                if (info) return Promise.resolve({ data: info });
            }
            // 兜底：从本地存储读取
            try {
                var stored = localStorage.getItem("hdfx_userinfo");
                if (stored) return Promise.resolve({ data: JSON.parse(stored) });
            } catch(e) {}
            return Promise.resolve({ data: { name: "user", role: "user", avatar: null, viptime: null } });
        }
        function l() {
            return Object(c["a"])({
                url: "/users/logout",
