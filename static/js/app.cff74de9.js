(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app"], {
    ...
    a18c: function (t, a, e) {
        ...
        function Ot(t) {
            // 赛事详情：通过 MQTT planRequest 获取
            return window.__hdfx_mqtt.planRequest("plan_matchinfo", t);
        }
        var Ft = {
        ...
        var Rt = {
            ...
            watch: {
                ...
                cccalshow: function (t) {
                    ...
                    this.cccaluteData.HGPoint = "") : (this.cccaluteData.JCPoint = this.configData.JCPointChuan != null ? this.configData.JCPointChuan : "",
                    this.cccaluteData.HGPoint = this.configData.HGPoint != null ? this.configData.HGPoint : "")
                },
                "configData.JCPointSinHad": function (t) {
                        this.configData.JCPointSin = t
                    },
                    "configData.JCPointSinTgg": function (t) {
                        this.configData.JCPointSin = t
                    },
                    "configData.JCPointSinHalf": function (t) {
                        this.configData.JCPointSin = t
                    },
                    "configData.JCPointSinLq": function (t) {
                        this.configData.JCPointSin = t
                    },
                    "configData.JCPointChuanHad": function (t) {
                        this.configData.JCPointChuan = t
                    },
                    "configData.JCPointChuanQb": function (t) {
                        this.configData.JCPointChuan = t
                    },
                    "configData.JCPointChuanLq": function (t) {
                        this.configData.JCPointChuan = t
                    },
                    "configData.JCPointChuanLqQb": function (t) {
                        this.configData.JCPointChuan = t
                    },
                    $route: "routerChange"
            },
            ...
            methods: {
                ...
                ccCalcute: function (t) {
                    ...
                    this.clearCcData(i),
                        ...
                        this.cccaluteData.JCPoint = this.configData.JCPointChuan != null ? this.configData.JCPointChuan : "",
                        this.cccaluteData.HGPoint = this.configData.HGPoint != null ? this.configData.HGPoint : "",
...
a.cccaluteData.JCPoint = a.configData.JCPointChuan != null ? a.configData.JCPointChuan : "",
a.cccaluteData.HGPoint = a.configData.HGPoint != null ? a.configData.HGPoint : "",
                                            c = t.jcMatch1,
                                            i = t.jcMatch2,
                                            n = t.hgMatch1,
                                            o = t.hgMatch2,
                                    ...
                                    case 2:
                                        ...
                                        if (window.ChuanCalc && window.ChuanCalc.compute) {
                                            _cr = window.ChuanCalc.compute({
                                                ...
                                                jcRebate: null != t.cccaluteData.JCPoint && "" !== t.cccaluteData.JCPoint ? parseFloat(t.cccaluteData.JCPoint) : .07,
                                                hgRebate: null != t.cccaluteData.HGPoint && "" !== t.cccaluteData.HGPoint ? parseFloat(t.cccaluteData.HGPoint) : .026,
                                                jcInput: null != t.cccaluteData.JCTzAmt && "" !== t.cccaluteData.JCTzAmt ? parseFloat(t.cccaluteData.JCTzAmt) : 5e3,
                ...
                calculate: function (t) {
                    ...
                    this.caluteData.JCPoint = this.configData.JCPointSin,
                    this.caluteData.HGPoint = this.configData.HGPoint;
                    var a = t.JCInfos;
