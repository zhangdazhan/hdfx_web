...
(function (global) {
  ...
  function compute(opts){
    ...
    var frozenHg1=(status2&&!ifAvgTrue)?prev:null;
    // console.warn('[ChuanCalc] #'+_callCount+' ident='+ident.substring(0,60)+'... status2='+status2+' ifAvg='+ifAvgTrue+' frozen='+!!frozenHg1+' prevKeys='+Object.keys(_prevMap).length);
    ...
    if(opts.ifAverg===true&&status2===true){
